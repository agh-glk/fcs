...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Quota.priority_pool'
        db.delete_column(u'manager_quota', 'priority_pool')
    ...
    def backwards(self, orm):
        # Adding field 'Quota.priority_pool'
        db.add_column(u'manager_quota', 'priority_pool',
