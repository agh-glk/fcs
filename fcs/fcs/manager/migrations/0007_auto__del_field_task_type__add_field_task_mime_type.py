...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'manager_task', 'type')

        # Adding field 'Task.mime_type'
        db.add_column(u'manager_task', 'mime_type',
                      self.gf('django.db.models.fields.CharField')(default='text/html', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Task.type'
        db.add_column(u'manager_task', 'type',
                      self.gf('django.db.models.fields.CharField')(default='text/html', max_length=250),
                      keep_default=False)

        # Deleting field 'Task.mime_type'
        db.delete_column(u'manager_task', 'mime_type')
    ...
    models = {
        ...
        u'manager.task': {
            ...
            'mime_type': ('django.db.models.fields.CharField', [], {'default': "'text/html'", 'max_length': '250', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            ...
            'start_links': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
