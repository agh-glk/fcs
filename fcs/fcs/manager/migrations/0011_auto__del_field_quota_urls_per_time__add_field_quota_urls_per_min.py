...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Quota.urls_per_time'
        db.delete_column(u'manager_quota', 'urls_per_time')

        # Adding field 'Quota.urls_per_min'
        db.add_column(u'manager_quota', 'urls_per_min',
                      self.gf('django.db.models.fields.IntegerField')(default=10000),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Quota.urls_per_time'
        db.add_column(u'manager_quota', 'urls_per_time',
                      self.gf('django.db.models.fields.IntegerField')(default=10000),
                      keep_default=False)

        # Deleting field 'Quota.urls_per_min'
        db.delete_column(u'manager_quota', 'urls_per_min')
    ...
    models = {
        ...
        u'manager.quota': {
            ...
            'urls_per_min': ('django.db.models.fields.IntegerField', [], {'default': '10000'}),
