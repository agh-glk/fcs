...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.server'
        db.alter_column(u'manager_task', 'server_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['manager.TaskServer'], unique=True, null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Task.server'
        db.alter_column(u'manager_task', 'server_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['manager.TaskServer'], unique=True, null=True))
