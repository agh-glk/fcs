...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Crawler.uuid'
        db.add_column(u'manager_crawler', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='uuid', unique=True, max_length=100),
                      keep_default=False)

        # Adding field 'TaskServer.uuid'
        db.add_column(u'manager_taskserver', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='uuid', unique=True, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Crawler.uuid'
        db.delete_column(u'manager_crawler', 'uuid')

        # Deleting field 'TaskServer.uuid'
        db.delete_column(u'manager_taskserver', 'uuid')
