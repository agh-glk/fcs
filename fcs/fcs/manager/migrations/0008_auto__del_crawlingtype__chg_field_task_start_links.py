...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.start_links'
        db.alter_column(u'manager_task', 'start_links', self.gf('django.db.models.fields.TextField')(max_length=1000))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Task.start_links'
        db.alter_column(u'manager_task', 'start_links', self.gf('django.db.models.fields.CharField')(max_length=1000))
