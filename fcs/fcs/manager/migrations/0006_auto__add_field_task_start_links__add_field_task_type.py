...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.start_links'
        db.add_column(u'manager_task', 'start_links',
    ...
    def backwards(self, orm):
        # Deleting field 'Task.start_links'
        db.delete_column(u'manager_task', 'start_links')
    ...
    models = {
        ...
        u'manager.task': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'text/html'", 'max_length': '250'}),
