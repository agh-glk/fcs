...
urlpatterns = patterns('',
                       ...
                       url(r'^accounts/', include(patterns(
                           url(r'^password/complete/', account_views.password_change_complete,
                               name='change_password_complete'),
                           url(r'^(?P<username>\w+)/password/$', userena_views.password_change,
                               {'template_name': 'change_password.html',
                                'success_url': 'change_password_complete'},
                               name='change_password'),
                           url(r'^(?P<username>\w+)/edit/$', account_views.edit_user_data,
                               name='edit_user_data'),
                           url(r'^(?P<username>\w+)/disabled/$', account_views.account_disabled,
